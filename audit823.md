...
ASC release state: `iOS 1.1.0 Ready for Distribution`. ASC evidence: [Analytics Overview](https://appstoreconnect.apple.com/apps/6792930447/analytics/overview?dateSpec=d90), selected range `dateSpec=d90`.
RevenueCat evidence: [Project Overview](https://app.revenuecat.com/projects/9c303632/overview), production mode, selected range `Last 28 days, 2026-07-27 through 2026-08-23`.
...
| ASC | conversion rate | 2.83% | comparison not displayed |
| ASC | proceeds | $1 | 90-day Analytics Overview |
| ASC | in-app purchases | 1 | 90-day Analytics Overview |
| RevenueCat | new customers | 4 | last 28 days |
| RevenueCat | active customers | 32 | last 28 days |
...
Football has only 6 ASC first-time downloads and 4 RevenueCat new customers, with one ASC in-app purchase and one active trial but no current active subscription or RevenueCat revenue. The sample is too small for a paywall winner. Verify the release build, make product load and purchase states observable, and use the first real cohort to test the first-value path.
